...
description: Fix bugs with systematic reproduction, root cause analysis, implementation, and verification. Use when fixing bugs, debugging issues, resolving defects, investigating regressions, or when the user reports broken behavior.
---
