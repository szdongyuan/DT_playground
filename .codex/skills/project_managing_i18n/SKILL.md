---
name: project-managing-i18n
description: Manage gettext i18n updates for this project from source extraction through merge, translation, and compilation. Use when adding, changing, removing, or reviewing user-visible UI text, labels, menus, dialogs, tooltips, validation messages, or translated strings.
---
