---
name: test-writing
description: Write Python tests with pytest using fixtures, parametrization, mocks, assertions, and focused test structure. Use when writing unit tests, integration tests, regression tests, pytest fixtures, mock-based tests, or test modules for new code.
---
