---
name: submitting-issues
description: Use when creating or submitting issues on the current branch, for bugs, features, tasks, or refactoring that need structured format with assignment and labels
---
