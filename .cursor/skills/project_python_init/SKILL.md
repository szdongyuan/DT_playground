---
name: project_python_init
description: Guide Python project creation by gathering requirements and generating config files and documentation. Use when creating new Python project, initializing project structure, or setting up project scaffolding.
---
