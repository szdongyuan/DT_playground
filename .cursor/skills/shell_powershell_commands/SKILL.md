---
name: shell_powershell_commands
description: Guide for executing PowerShell commands on Windows systems. Use when running terminal commands, file operations, process management, or any shell operations on Windows.
---
