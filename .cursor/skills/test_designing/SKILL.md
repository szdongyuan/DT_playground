---
name: test_designing
description: Guide for designing test cases using systematic methods like equivalence partitioning, boundary value analysis, and scenario coverage. Use when planning tests, designing test cases, or when the user needs to analyze what to test.
---
