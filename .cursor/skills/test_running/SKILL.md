---
name: test_running
description: Guide for running Python tests with pytest, analyzing results, generating coverage reports, and configuring test environments. Use when executing tests, checking coverage, or when the user needs help with pytest commands and configuration.
---
